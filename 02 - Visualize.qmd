...
![](media/covid_histogram.png){.two-thirds fig-align="center"}
...
This first exercise is pretty simple, I'm just filling in the blanks, so I'll add "covid_testing" in the first blank,
"geom_histogram" in the second blank, and "pan_day" in the third.
...
![](media/blue_histogram.png){.two-thirds fig-align="center"}
...
## Your Turn #6 {background-color="#e3faf1" .smaller}
